...
<div class="card" id="vn-fruit-importers">
  ...
  <p><b>Kênh hiện đại / chuỗi &amp; B2B (từ nguồn công khai):</b></p>
  <table>
  ...
  <p style="margin-top:1rem"><b>Kênh chợ đầu mối &amp; chợ truyền thống — nơi đi phần lớn volume:</b></p>
  <table>
    <tr><th>Đầu mối</th><th>Quy mô / vai trò</th><th>Cách tiếp cận</th></tr>
    <tr><td><b>Chợ đầu mối Thủ Đức</b> (TP.HCM)</td>
        <td>2.800–3.500 tấn nông sản/đêm — trạm trung chuyển trái cây lớn nhất phía Nam;
            có cả hàng nhập (nho Nam Phi, táo Envy, táo Ba Lan…)</td>
        <td>Qua Công ty Quản lý chợ (Thủ Đức Agromarket) để có danh sách thương nhân
            ô vựa ngành trái cây</td></tr>
    <tr><td><b>Chợ Bình Điền &amp; Hóc Môn</b> (TP.HCM)</td>
        <td>Cụm chợ sỉ kế thừa Cầu Muối/Cầu Ông Lãnh; đặc sản miền Tây + hàng nhập</td>
        <td>Ban quản lý chợ (Satra vận hành Bình Điền)</td></tr>
    <tr><td><b>Chợ Long Biên</b> (Hà Nội)</td>
        <td>Chợ đầu mối trái cây lớn nhất miền Bắc; tỷ trọng lớn hàng Trung Quốc</td>
        <td>BQL chợ + các vựa lớn lâu năm (giao dịch ban đêm)</td></tr>
    <tr><td><b>Cụm cửa khẩu Lạng Sơn (Tân Thanh) / Lào Cai (Kim Thành) / Móng Cái</b></td>
        <td>Cửa ngõ chính của trái cây Trung Quốc (~$220M/năm chỉ riêng trái cây tươi);
            nhà nhập thực tế là các công ty XNK biên mậu + vựa tại cửa khẩu, sau đó tỏa
            về Long Biên/Thủ Đức</td>
        <td>Hiệp hội doanh nghiệp XNK địa phương, chi cục hải quan cửa khẩu</td></tr>
  </table>

  <div class="insights"><b>⚠️ Lưu ý phương pháp</b><ul>
    <li>Kênh chợ đầu mối/truyền thống chiếm <b>phần lớn volume trái cây nhập</b> (đặc
        biệt hàng Trung Quốc) nhưng thương nhân vựa hầu như <b>không có hiện diện công
        khai</b> (không website/báo chí) — không thể xếp hạng từng vựa từ nguồn mở;
        phải đi qua BQL chợ, hiệp hội biên mậu hoặc dữ liệu tờ khai hải quan.</li>
